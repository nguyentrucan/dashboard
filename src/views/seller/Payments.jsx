  ...
  const Row = ({ index, style }) => {
    return (
      <div style={style} className="flex text-sm text-white font-medium">
        ...
        <div className="w-[25%] p-2 whitespace-nowrap">$2322</div>
        <div className="w-[25%] p-2 whitespace-nowrap">
          <span className="py-[1px] px-[5px] bg-slate-300 text-blue-500 rounded-md text-sm">
            Pending
          </span>
        </div>
        <div className="w-[25%] p-2 whitespace-nowrap">17 Apr 2025</div>
      </div>
    );
  };
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7 mb-5">
        ...
        <div className="flex justify-between items-center p-5 bg-[#fae8e8] rounded-md gap-3">
          <div className="flex flex-col justify-start text-[#5c5a5a]">
            <h2 className="text-2xl font-bold">$34343</h2>
            ...
            <form>
              <div className="flex gap-3 flex-wrap">
                <input
                  type="number"
                  min="0"
                  className="px-4 py-2 md:w-[79%] focus:border-indigo-500 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]"
                  name="amount"
                />
